...
public class CharacterSelectionFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        imageViewChar1 = layout.findViewById(R.id.imageViewTop);
        imageViewChar2 = layout.findViewById(R.id.imageViewMiddle);
        imageViewChar3 = layout.findViewById(R.id.imageViewBottom);
