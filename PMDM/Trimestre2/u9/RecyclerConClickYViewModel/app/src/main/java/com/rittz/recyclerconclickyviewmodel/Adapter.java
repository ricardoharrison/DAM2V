...
public class Adapter extends RecyclerView.Adapter<Adapter.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            view.setOnClickListener(v -> {
                ...
                i.putExtra("INFO_1", textViewNombre.getText().toString());
                i.putExtra("INFO_2", textViewDescripcion.getText().toString());
                i.putExtra("INFO_3", textViewEstrellas.getText().toString());
    ...
    public void onBindViewHolder(ViewHolder viewHolder, final int position) {
        ...
        viewHolder.textViewEstrellas.setText("" + items.get(position).getEstrellas());
